...
book = xlrd.open_workbook('/Users/peco/Desktop/co/samples_ori.xlsx')
sheet = book.sheet_by_index(0)
with open('/Users/peco/Desktop/co/clean_samples.txt', 'w') as f:
    for i in sheet.get_rows():
        words, text = [i[1].value, i[2].value, i[3].value], i[4].value
